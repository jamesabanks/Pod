CFLAGS = -O2 -Wall
sources_c = pod_char.c pod_string.c pod_list.c pod_mapping.c pod_marker.c \
    pod_scan_add_char.c pod_scan_add_token.c                 \
...
sources_h = pod_boolean.h pod_char.h pod_list.h pod_log.h  \
